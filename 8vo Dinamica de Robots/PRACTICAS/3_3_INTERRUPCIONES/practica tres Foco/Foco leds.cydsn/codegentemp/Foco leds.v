// ======================================================================
// Foco leds.v generated from TopDesign.cysch
// 02/19/2020 at 02:36
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a2366bb1-b351-4150-8bf0-2f930ccb1dbb/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("45b943e1-fd3c-4d2b-b800-35845e3192af"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6f399fff-03c4-43b3-902d-5091820461ae"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e77c66c7-aa6d-4b18-8ddf-e7c1d1a6eda2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f5c1e26f-22d4-447f-81ce-f094ded3da47"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("64fa126c-875d-4007-9e6a-92aa9209643b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("00926bcf-0bb1-4ca0-92bc-acb8f0f24485"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f8e266ad-eaf8-410f-b060-4e9d9710ae37"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("cdedbb30-4598-49b2-b564-01b382b0d3f8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a179b170-f023-4397-9dca-61d5047d1d18"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f2db0417-f85a-4b21-b0dc-aebad1896fa9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__FOCO_net;
	wire [0:0] tmpFB_0__FOCO_net;
	wire [0:0] tmpIO_0__FOCO_net;
	wire [0:0] tmpINTERRUPT_0__FOCO_net;
	electrical [0:0] tmpSIOVREF__FOCO_net;
	...
	cy_psoc3_pins_v1_10
		...
		FOCO
		 (.oe(tmpOE__FOCO_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__FOCO_net[0:0]}),
		  .io({tmpIO_0__FOCO_net[0:0]}),
		  .siovref(tmpSIOVREF__FOCO_net),
		  .interrupt({tmpINTERRUPT_0__FOCO_net[0:0]}),
		  .annotation({Net_12}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__FOCO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

...
{
    uint8 staticBits = (LED10_DR & (uint8)(~LED10_MASK));
    LED10_DR = staticBits | ((uint8)(value << LED10_SHIFT) & LED10_MASK);
}
...
{
	CyPins_SetPinDriveMode(LED10_0, mode);
}
...
{
    return (LED10_PS & LED10_MASK) >> LED10_SHIFT;
}
...
{
    return (LED10_DR & LED10_MASK) >> LED10_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(LED10_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & LED10_0_INTR) != 0u) 
		{ 
			 LED10_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (LED10_INTSTAT & LED10_MASK) >> LED10_SHIFT;
    }

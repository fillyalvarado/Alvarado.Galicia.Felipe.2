...
{
    uint8 staticBits = (LED9_DR & (uint8)(~LED9_MASK));
    LED9_DR = staticBits | ((uint8)(value << LED9_SHIFT) & LED9_MASK);
}
...
{
	CyPins_SetPinDriveMode(LED9_0, mode);
}
...
{
    return (LED9_PS & LED9_MASK) >> LED9_SHIFT;
}
...
{
    return (LED9_DR & LED9_MASK) >> LED9_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(LED9_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & LED9_0_INTR) != 0u) 
		{ 
			 LED9_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (LED9_INTSTAT & LED9_MASK) >> LED9_SHIFT;
    }
